...
socket = socketIOClient('https://rewebrtc.herokuapp.com', {transports: ['websocket'], jsonp: false},{'force new conncetion':true});
//可以用的

 // socket = socketIOClient('ws://192.168.1.115:4443', {transports: ['websocket'], jsonp: false});

var configuration = {"iceServers": [{"url": "stun:59.110.239.23"}]};
...
function stop() {
  ...
  socket.connect('https://rewebrtc.herokuapp.com', {transports: ['websocket'], jsonp: false},{'force new conncetion':true});
  console.log("stop");
