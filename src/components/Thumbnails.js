...
import {StyleSheet, Text, TouchableHighlight, View, ListView, Image,TouchableOpacity} from 'react-native';
...
export default class Thumbnails extends Component {
  ...
  renderRow(stream, sectionId, rowId) {
    ...
    return <TouchableOpacity style={styles.thumbnailContainer}
